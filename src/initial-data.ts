...
export const INITIAL_CATEGORIES: DocumentCategory[] = [
  ...
  },
  {
    ...
    name: 'Birth Certificate Draft (NPC Style)',
    description: 'Generates a highly polished, visually authentic National Population Commission (NPC) style Birth Certificate / Attestation of Birth Draft.',
    priceNGN: 2500,
    templateStyle: 'modern',
    requiredFields: [
      { key: 'childName', label: 'Child Full Name', placeholder: 'e.g., Adebayo Kunle Musa', type: 'text', required: true },
      { key: 'gender', label: 'Gender', placeholder: 'Male / Female', type: 'text', required: true },
      { key: 'dateOfBirth', label: 'Date of Birth', placeholder: 'e.g., October 24, 2020', type: 'text', required: true },
      { key: 'bornPlace', label: 'Place of Birth', placeholder: 'e.g., Gbagada General Hospital, Lagos', type: 'text', required: true },
      { key: 'fatherName', label: "Father's Full Name", placeholder: 'e.g., Musa Kunle Adebayo', type: 'text', required: true },
      { key: 'motherName', label: "Mother's Full Name", placeholder: 'e.g., Deaconess Oluwaseun Musa', type: 'text', required: true },
      { key: 'lga', label: 'LGA of Birth', placeholder: 'e.g., Kosofe LGA', type: 'text', required: true },
      { key: 'state', label: 'State of Origin', placeholder: 'e.g., Lagos State', type: 'text', required: true },
      { key: 'informantName', label: 'Informant/Reporter Name (Optional)', placeholder: 'e.g., Musa Kunle Adebayo', type: 'text', required: false },
      { key: 'certificateNo', label: 'Reference Certificate Number', placeholder: 'e.g., NPC-B/2026/08917', type: 'text', required: true },
      { key: 'stylePreset', label: 'Certificate Visual Style Preset', placeholder: 'Select style option', type: 'select', options: [
        'Imo Heartland (Green teeth border)',
        'Lagos Epe Style (Tri-color banner)',
        'Oguta Classic (Double green circle)',
        'Cross River Ikom (Dual royal blue border)',
    ...
    samplePreview: "NATIONAL POPULATION COMMISSION\nFEDERAL REPUBLIC OF NIGERIA\n\nNo: NPC-B/2026/08917\n\nATTESTATION OF BIRTH (BIRTH CERTIFICATE)\n\nThis is to certify that ADEBAYO KUNLE MUSA (MALE) was born in Gbagada General Hospital, Lagos on October 24, 2020.\n\nThe father's name is Musa Kunle Adebayo and the mother's name is Deaconess Oluwaseun Musa.\n\nThis registration was entry filed under Kosofe LGA of Lagos State.\n\nIssued by the Registrar.",
    aiPromptTemplate: 'Generate a gorgeous and medically exact National Population Commission style Birth Certificate / Attestation of Birth Draft. Certify that {childName} ({gender}) was born at {bornPlace} on {dateOfBirth} under {lga} LGA of {state}, Nigeria. Father’s name is {fatherName} and Mother’s name is {motherName}. Reference certificate register number is {certificateNo}. Informant is {informantName}. Add appropriate registrar seals and NPC statutory clauses.'
  },
  {
